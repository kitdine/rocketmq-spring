...
package org.jobshen.mq.rocketmq.test.base;
...
import org.jobshen.mq.rocketmq.test.util.MQAdmin;
import org.jobshen.mq.rocketmq.test.util.TestUtils;
import org.junit.Assert;

import lombok.extern.log4j.Log4j2;

/**
 * IntegrationTestBase Description:
 *
...
public class IntegrationTestBase {
    ...
    private static String createBaseDir() {
        ...
        if (file.exists()) {
            log.info(String.format("[%s] has already existed, please back up and remove it for integration tests", baseDir));
            System.exit(1);
        }
        TMPE_FILES.add(file);
        return baseDir;
